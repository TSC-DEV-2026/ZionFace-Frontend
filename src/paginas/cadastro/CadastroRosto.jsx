          ...
          <div className="space-y-5">
            ...
            <div
              className={clsx(
                ...
                append ? "border-accent/30 bg-accent-glow" : "border-border bg-surface hover:border-border/80"
              )}
            ...
            >
              ...
              <div className={clsx("w-10 h-6 rounded-full transition-all relative", append ? "bg-accent" : "bg-border")}>
                <div className={clsx("absolute top-1 w-4 h-4 rounded-full bg-void transition-all", append ? "left-5" : "left-1")} />
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              {inputMode === "upload" ? (
                <ImageDropzone onFile={setFile} label="Arraste a foto de referência aqui" />
              ) : (
                <CameraCapture
            ...
            <div className="flex gap-2 text-xs text-muted rounded-lg bg-panel border border-border p-3">
              ...
              <span>
                Use fotos frontais, com boa iluminação e sem óculos escuros. O detector RetinaFace é usado no cadastro para máxima qualidade.
              </span>
            </div>
