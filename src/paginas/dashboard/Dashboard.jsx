...
const FEATURES = [
  {
    ...
    description:
      "Registre a face de referência de um usuário. Suporta múltiplas referências para maior precisão.",
    to: "/enroll",
    accent: "#00F5A0",
  },
  {
    ...
    description:
      "Compare uma selfie contra o embedding cadastrado. Resultado em tempo real com score de distância.",
    to: "/verify",
    accent: "#00F5A0",
  },
];
...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen grid-bg">
      {/* Hero */}
      <div className="relative pb-14 sm:pb-20 px-4 sm:px-6">
        {/* Radial glow */}
        <div
          className="absolute top-0 left-1/2 -translate-x-1/2 w-[520px] sm:w-[600px] h-[360px] sm:h-[400px] pointer-events-none"
          style={{
            background:
              "radial-gradient(ellipse at center, rgba(0,245,160,0.08) 0%, transparent 70%)",
          }}
        />
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          ...
          <h1 className="font-display font-extrabold leading-[0.95] tracking-tight mb-6 text-[clamp(2.4rem,10vw,4.5rem)] break-words">
            Reconhecimento
            <br />
            <span className="text-accent">Facial</span>
          </h1>

          <p className="text-base sm:text-lg text-subtle max-w-xl mx-auto leading-relaxed">
            Sistema de verificação biométrica baseado em{" "}
            <span className="text-text font-medium">ArcFace</span>, com detecção em dois estágios
            e estratégia de zona cinza para alta precisão.
          </p>
        </div>
      </div>

      <div className="max-w-5xl mx-auto px-4 sm:px-6 pb-20 sm:pb-24 space-y-12 sm:space-y-16">
        {/* Action cards */}
